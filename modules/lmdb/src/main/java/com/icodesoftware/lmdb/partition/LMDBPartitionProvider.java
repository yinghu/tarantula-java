...
public class LMDBPartitionProvider implements Serviceable {
    ...
    private LMDBPartition keyIndex;
    ...
    public void start() throws Exception {
        ...
        keyIndex = new LMDBPartition(envSetting(storeMbSize,basePath+"/index",1));
        keyIndex.start();
        LMDBPartition partition1 = new LMDBPartition(envSetting(storeMbSize,basePath+"/1",1));
        partition1.start();
