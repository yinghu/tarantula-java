    ...
    public static BattleUpdate fromJson(byte[] json){
        ...
        switch (target) {
            ...
            case ManualAnalytics:
                ...
                break;
            case CurrencyUpdate:
                update = CurrencyUpdate.fromJson(jsonObject);
                break;
            case HardCurrencyBuythroughShown:
                update = HardCurrencyBuythroughShown.fromJson(jsonObject);
                break;
            case HardCurrencyBuythrough:
                update = HardCurrencyBuythrough.fromJson(jsonObject);
                break;
            case ManualAnalyticsBatch:
                update = ManualAnalyticsBatch.fromJson(jsonObject);
                break;
            case TournamentScore:
                update = TournamentScore.fromJson(jsonObject);
                break;
            default:
