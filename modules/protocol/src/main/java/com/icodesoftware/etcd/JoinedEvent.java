...
public class JoinedEvent extends EtcdEvent{
    ...
    private JoinedEvent(String nodeName, String httpEndpoint){
        this();
    ...
    public static JoinedEvent create(){
        return new JoinedEvent();
    }

    public static JoinedEvent create(String nodeName, String httpEndpoint){
        return new JoinedEvent(nodeName,httpEndpoint);
    }
}
