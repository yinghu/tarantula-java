...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class AdminBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (AdminNetworkObject)obj;
			networkObject.AttachedBehavior = this;

			base.SetupHelperRpcs(networkObject);
			networkObject.RegisterRpc("OnTimer", OnTimer, typeof(int));
		...
		{
			Initialize(new AdminNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new AdminNetworkObject(networker, this, createCode, metadata);
		}
