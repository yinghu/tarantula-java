...
public class LoadResult {
    ...
    public static String print(){
        return "(Total bytes)"+totalBytesReceived.get()+"(1-10)"+totalRoundTrip1_10.get()+"(11-50)"+totalRoundTrip11_50+"(51-100)"+totalRoundTrip51_100+"(101-500)"+totalRoundTrip101_500+"(>500)"+totalRoundTripMore500;
    }
}
