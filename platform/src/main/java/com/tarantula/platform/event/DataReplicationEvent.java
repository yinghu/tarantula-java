...
public class DataReplicationEvent extends Data implements Event {

    public OnReplication[] data;
    public DataReplicationEvent(){

    }
    public DataReplicationEvent(ClusterProvider.Node sourceNode, OnReplication[] onReplication, ClusterProvider.Node targetNode){
        this.source = sourceNode.nodeName();
        this.data = onReplication;
        this.destination = targetNode.nodeName()+"."+ RecoverService.NAME;
    }
    @Override
