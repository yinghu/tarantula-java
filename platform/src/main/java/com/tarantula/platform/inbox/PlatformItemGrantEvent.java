...
public class PlatformItemGrantEvent extends RecoverableObject {
    ...
    public PlatformItemGrantEvent(){
        this.onEdge = true;
        this.label = LABEL;
    }

    public PlatformItemGrantEvent(String type, String itemID, String itemName, int amount, boolean completed, LocalDateTime dateCreated){
        this();
        this.type = type;
        this.itemID = itemID;
