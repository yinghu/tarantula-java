...
public class TarantulaApplicationContext implements ApplicationContext, EventListener, Connection.OnStateListener{
    ...
    public void setupOnInstanceRegistry(){
        if(!started.getAndSet(true)){
            try{
                List<OnInstance> olist = this.tarantulaContext.queryFromDataMaster(PortableRegistry.OID,new OnInstanceQuery(this._instance.distributionKey()),new String[]{this._instance.distributionKey()},false);
                if(olist.isEmpty()){
