...
public class AccessControl implements Access.Role {
    ...
    public static final Access.Role admin = new AccessControl("admin",Access.ADMIN_ACCESS_CONTROL);
    public static final Access.Role account = new AccessControl("account",Access.ACCOUNT_ACCESS_CONTROL);
