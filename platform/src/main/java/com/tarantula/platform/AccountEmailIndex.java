...
public class AccountEmailIndex extends RecoverableObject {
    ...
    public AccountEmailIndex(String bucket, String typeId){
        this.bucket = bucket;
        this.label =  typeId;
    }
    public AccountEmailIndex(String bucket, String typeId, String index, String owner){
        this();
        this.bucket = bucket;
        this.label =  typeId;
        this.index = index;
