...
public class TarantulaMain {
	...
	public static  class _Runtime{
		...
		public void bootstrap() throws Exception{
			...
			TarantulaContext.lobbySubscriptionEnabled = Boolean.parseBoolean(override(overriding,"tarantula.platform.cluster.run.as.mirror",_user,_config));
			btx.runAsMirror = Boolean.parseBoolean(override(overriding,"tarantula.lobby.subscription.enabled",_user,_config));
