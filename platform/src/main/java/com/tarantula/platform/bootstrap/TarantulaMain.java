...
public class TarantulaMain {
	...
	public static  class _Runtime{
		...
		public void bootstrap() throws Exception{
			...
			btx.kubernetesServiceName = override(overriding,"tarantula.member.discovery.kubernetes.service.name",_user,_config);
			...
			if(btx.homingAgentEnabled) btx.homingAgentHost = override(overriding,"tarantula.homing.agent.host",_user,_config);
