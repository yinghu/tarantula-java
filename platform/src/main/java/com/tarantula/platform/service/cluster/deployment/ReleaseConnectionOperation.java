...
public class ReleaseConnectionOperation extends Operation {
    ...
    public ReleaseConnectionOperation() {
    }


    public ReleaseConnectionOperation(String typeId,Connection connection) {
        this.typeId = typeId;
