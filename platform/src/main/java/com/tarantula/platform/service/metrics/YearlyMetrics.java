...
public class YearlyMetrics extends RecoverableObject {

    private Property[] metrics;
    private int trackingNumber;

    public YearlyMetrics(int trackingNumber){
        this.trackingNumber = trackingNumber;
        this.metrics = new Property[trackingNumber];
    }

    public YearlyMetrics(){
    ...
    public int getClassId() {
        return StatisticsPortableRegistry.YEARLY_METRICS_CID;
    }
