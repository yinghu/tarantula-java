                ...
                try{
                    ...
                    if(updates.size()>0){
                        updates.forEach(r->{
                            ...
                            KeyIndexEvent keyIndexEvent = new KeyIndexEvent(AccessIndexService.AccessIndexStore.STORE_NAME_PREFIX+r.partition(),new String(r.key()),new String(ro.node),this.tarantulaContext.node().nodeName());
