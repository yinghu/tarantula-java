...
public class GoogleStorePurchaseValidator extends AuthObject {
    ...
    public boolean validate(Map<String, Object> params) {
        try {
            ...
            storeServiceProvider.transactionLog(new StoreTransactionLog(Long.parseLong(systemId),OnAccess.GOOGLE_STORE,pendingTransactionId,shoppingItem.distributionId(),suc));
            if (suc) return true;
