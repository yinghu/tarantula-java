 ...
 */
public class BaccaratBankerHand extends Seat {
    public Card[] hand;
    public boolean standing;

    private Baccarat baccarat;
    public BaccaratBankerHand(Baccarat baccarat){
        this.stub = Baccarat.BANKER_LINE_ID;
        this.name = "BaccaratBankerHand";
        this.label = "baccarat";
    ...
    public BaccaratBankerHand setup(){
        return this;
    }
}
