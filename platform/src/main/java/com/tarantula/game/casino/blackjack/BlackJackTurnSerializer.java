 ...
 */
public class BlackJackTurnSerializer implements JsonSerializer<BlackJackTurn> {


    public JsonElement serialize(BlackJackTurn turn, Type type, JsonSerializationContext jsonSerializationContext) {
