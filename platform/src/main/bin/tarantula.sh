...
JAVA_OPTS="$JAVA_OPTS -server -Xms24g -Xmx24g -XX:+UseG1GC -XX:+UseCompressedOops -XX:MaxGCPauseMillis=200 -XX:ParallelGCThreads=20 -XX:ConcGCThreads=5 -XX:InitiatingHeapOccupancyPercent=70"
