...
public class InventoryTest extends DataStoreHook{
    ...
    public void inventoryTest() {
        ...
        UserInventory gold = new UserInventory("HardCurrency","Gold",true);
        ...
        UserInventory gem = new UserInventory("HardCurrency","Gem",true);
        ...
        RecoverableQuery<UserInventory> query = RecoverableQuery.query(presenceId,gold, ItemPortableRegistry.INS);
