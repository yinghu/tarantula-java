...
public class ThirdPartyLoginTest extends DataStoreHook{
    ...
    public void thirdPartyLoginTest() {
        ...
        thirdPartyLogin.distributionKey("2345236235229643");
        thirdPartyLogin.dataStore(dataStore);
        dataStore.createIfAbsent(thirdPartyLogin,false);
        ...
        thirdPartyLogin.distributionKey("2345236235229643");
        thirdPartyLogin.dataStore(dataStore);
        dataStore.load(thirdPartyLogin);

        Assert.assertEquals(token, thirdPartyLoginLoaded.thirdPartyToken());
    }
}
